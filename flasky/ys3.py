from flasky.gs3 import googleplace, googlesearch
from flasky.zs3 import zomatoplace, zomatosearch
...
class yelpsearch:
    ...
    def get_placeidlist(self, jobnumber=0):
        ...
        for yelpid in self.yelpidlist:
            ...
            mygooglesearch = googlesearch(myyelpplace.get_location(),100,[], myyelpplace.get_placename())
            ...
            myzomatosearch = zomatosearch(myyelpplace.get_location(), 100, keyword=myyelpplace.get_placename())
            if len(myzomatosearch.get_zomatoidlist()) != 0:
                myzomatoplace = zomatoplace(myzomatosearch.get_zomatoidlist()[0])
